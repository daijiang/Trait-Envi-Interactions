...
ggsave(filename = "figures/type_power.pdf", plot = type_power_plot, width = 7, height = 10)

## Fig. 4 se vs abs(est) ----
est_se_plt(nsp = 32, alpha = 0.8, trait2_C = T, text1_x = 1.263, text2_x = 1.25, text1_y = 0.08)
ggsave(filename = "figures/se_est_sp32.pdf", height = 5, width = 10)
...
ggsave(filename = "figures/se_est_sp32_2.pdf", height = 5, width = 10)
