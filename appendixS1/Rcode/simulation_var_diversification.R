...
sim_init = function(nspp = 30, nsite = 30, physig.trait1 = TRUE,
                    physig.trait2 = TRUE, birth.rate = 1, death.rate = 0,
  ...
  phy = drop.extinct(sim.bdtree(b = birth.rate, d = death.rate, stop = "taxa", n = nspp, extinct = FALSE))
...
sim_n = function(n = 10, mc.cores = 4, nspp = 30, nsite = 30,
  ...
  if(beta_5 == 0){
    if(!dir.exists("./rds_var_bd")) dir.create("rds_var_bd")
    saveRDS(output, file = paste("rds_var_bd/sp", nspp, "site", nsite, "_",
                                 "birth", birth.rate, "death", death.rate, "_",
                                 as.integer(physig.trait1),
                                 as.integer(physig.trait2),
                                 ".rds", sep = ""))
  } else{ # this is for power analyses
    if(!dir.exists("./rds2_var_bd")) dir.create("rds2_var_bd")
    saveRDS(output, file = paste("rds2_var_bd/sp", nspp, "site", nsite, "_",
                                 "birth", birth.rate, "death", death.rate, "_",
...
n_cores = 6
n_inter = 300
# sim_n(n = 100, nspp = 20, nsite = 30, birth.rate = 1, death.rate = 0.1, mc.cores = n_cores, beta_5 = 0, physig.trait1 = T, physig.trait2 = F)
# sim_n(n = 100, nspp = 20, nsite = 30, birth.rate = 1, death.rate = 0.1, mc.cores = n_cores, beta_5 = 0, physig.trait1 = F, physig.trait2 = F)
# sim_n(n = 100, nspp = 20, nsite = 30, birth.rate = 1, death.rate = 0.1, mc.cores = n_cores, beta_5 = 0, physig.trait1 = F, physig.trait2 = T)
sim_n(n = n_inter, nspp = 40, nsite = 30, birth.rate = 1, death.rate = 0.1, mc.cores = n_cores, beta_5 = 0, physig.trait1 = T, physig.trait2 = T)
sim_n(n = n_inter, nspp = 40, nsite = 30, birth.rate = 1, death.rate = 0.3, mc.cores = n_cores, beta_5 = 0, physig.trait1 = T, physig.trait2 = T)
sim_n(n = n_inter, nspp = 40, nsite = 30, birth.rate = 1, death.rate = 0.5, mc.cores = n_cores, beta_5 = 0, physig.trait1 = T, physig.trait2 = T)
sim_n(n = n_inter, nspp = 40, nsite = 30, birth.rate = 1, death.rate = 0.8, mc.cores = n_cores, beta_5 = 0, physig.trait1 = T, physig.trait2 = T)
