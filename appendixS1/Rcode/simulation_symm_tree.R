...
## this function is to get an initial set of s2 for random effects
## for following simulations, to improve speed.
sim_init = function(nspp = 2^4, nsite = 30, physig.trait1 = TRUE,
                    physig.trait2 = TRUE,
  ...
  # simulate a symmetrical phylogeny
  phy = compute.brlen(stree(n = nspp, type = "balanced"))
...
# type I error
sim_n(n = nitem, nspp = 2^4, nsite = 30, mc.cores = ncore, beta_5 = 0, physig.trait1 = T, physig.trait2 = T)
sim_n(n = nitem, nspp = 2^4, nsite = 30, mc.cores = ncore, beta_5 = 0, physig.trait1 = F, physig.trait2 = T)
sim_n(n = nitem, nspp = 2^4, nsite = 30, mc.cores = ncore, beta_5 = 0, physig.trait1 = T, physig.trait2 = F)
sim_n(n = nitem, nspp = 2^4, nsite = 30, mc.cores = ncore, beta_5 = 0, physig.trait1 = F, physig.trait2 = F)

sim_n(n = nitem, nspp = 2^5, nsite = 30, mc.cores = ncore, beta_5 = 0, physig.trait1 = T, physig.trait2 = T)
sim_n(n = nitem, nspp = 2^5, nsite = 30, mc.cores = ncore, beta_5 = 0, physig.trait1 = F, physig.trait2 = T)
sim_n(n = nitem, nspp = 2^5, nsite = 30, mc.cores = ncore, beta_5 = 0, physig.trait1 = T, physig.trait2 = F)
sim_n(n = nitem, nspp = 2^5, nsite = 30, mc.cores = ncore, beta_5 = 0, physig.trait1 = F, physig.trait2 = F)

sim_n(n = nitem, nspp = 2^6, nsite = 30, mc.cores = ncore, beta_5 = 0, physig.trait1 = T, physig.trait2 = T)
sim_n(n = nitem, nspp = 2^6, nsite = 30, mc.cores = ncore, beta_5 = 0, physig.trait1 = F, physig.trait2 = T)
sim_n(n = nitem, nspp = 2^6, nsite = 30, mc.cores = ncore, beta_5 = 0, physig.trait1 = T, physig.trait2 = F)
sim_n(n = nitem, nspp = 2^6, nsite = 30, mc.cores = ncore, beta_5 = 0, physig.trait1 = F, physig.trait2 = F)

# type II error
# sim_n(n = nitem, nspp = 2^5, nsite = 30, mc.cores = ncore, beta_5 = 0.25, physig.trait1 = T, physig.trait2 = T)
# sim_n(n = nitem, nspp = 2^5, nsite = 30, mc.cores = ncore, beta_5 = 0.25, physig.trait1 = F, physig.trait2 = T)
# sim_n(n = nitem, nspp = 2^5, nsite = 30, mc.cores = ncore, beta_5 = 0.25, physig.trait1 = T, physig.trait2 = F)
# sim_n(n = nitem, nspp = 2^5, nsite = 30, mc.cores = ncore, beta_5 = 0.25, physig.trait1 = F, physig.trait2 = F)

sim_n(n = nitem, nspp = 2^5, nsite = 30, mc.cores = ncore, beta_5 = 0.50, physig.trait1 = T, physig.trait2 = T)
sim_n(n = nitem, nspp = 2^5, nsite = 30, mc.cores = ncore, beta_5 = 0.50, physig.trait1 = F, physig.trait2 = T)
sim_n(n = nitem, nspp = 2^5, nsite = 30, mc.cores = ncore, beta_5 = 0.50, physig.trait1 = T, physig.trait2 = F)
sim_n(n = nitem, nspp = 2^5, nsite = 30, mc.cores = ncore, beta_5 = 0.50, physig.trait1 = F, physig.trait2 = F)

# sim_n(n = nitem, nspp = 2^5, nsite = 30, mc.cores = ncore, beta_5 = 0.75, physig.trait1 = T, physig.trait2 = T)
# sim_n(n = nitem, nspp = 2^5, nsite = 30, mc.cores = ncore, beta_5 = 0.75, physig.trait1 = F, physig.trait2 = T)
# sim_n(n = nitem, nspp = 2^5, nsite = 30, mc.cores = ncore, beta_5 = 0.75, physig.trait1 = T, physig.trait2 = F)
# sim_n(n = nitem, nspp = 2^5, nsite = 30, mc.cores = ncore, beta_5 = 0.75, physig.trait1 = F, physig.trait2 = F)

sim_n(n = nitem, nspp = 2^5, nsite = 30, mc.cores = ncore, beta_5 = 1.00, physig.trait1 = T, physig.trait2 = T)
sim_n(n = nitem, nspp = 2^5, nsite = 30, mc.cores = ncore, beta_5 = 1.00, physig.trait1 = F, physig.trait2 = T)
sim_n(n = nitem, nspp = 2^5, nsite = 30, mc.cores = ncore, beta_5 = 1.00, physig.trait1 = T, physig.trait2 = F)
sim_n(n = nitem, nspp = 2^5, nsite = 30, mc.cores = ncore, beta_5 = 1.00, physig.trait1 = F, physig.trait2 = F)