---
title: 'Responses to reviewers: figures'
...
2. compared type I errors of LMM and PLMM when phylogenies were simulated with simple birth-death model but with different death rates.
...
Here are the figures resulted from simulations with balanced phylogenies. They show the same pattern as those in the manuscript.  
...
```{r fig4, fig.width=8, fig.asp=0.55}
